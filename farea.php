			...
			<div class="inner-content">	
				<div class="outter-wp">
					...
					<div id="tabs" class="tabs">
						<h1 style="padding-left: 50px;font-weight: bold">ÁREA</h1>
						<div class="graph">
							<nav>
								<ul>
									<li><a href="#section-1" class="icon-shop"><i class="fa fa-file-text-o"></i><span style="padding-left: 5px;">Maestro</span></a></li>
							...
							<div class="content tab">
								<section id="section-1">
									<div class="graph-2 general">
										<h2 style="color:#052963; font-size: 1.8em; padding-bottom: 15px;">Formulario Maestro de Área </h2>
										<div class="form-body">
											<form class="form-horizontal" data-model="AreaViewModel" data-bind="submit:save">
												<div class="col-md-6 general">
													...
													<div class="form-group">
														<label for="inputEmail3" class="col-sm-4 control-label">Nombre de Área</label>
														<div class="col-sm-8">
															<input type="text" data-bind="value:nombre" class="form-control" id="focusedinput" placeholder="Default Input">
														</div> 
													</div>
													<div class="form-group"> 
														<label for="inputEmail3" class="col-sm-4 control-label">Código de Área</label> 
														<div class="col-sm-8"> 
															<input type="text" data-bind="value:folio" class="form-control" id="focusedinput" placeholder="Default Input">
														</div> 
													</div>
													<div class="form-group"> 
														<label for="inputEmail3" class="col-sm-4 control-label">Tipo de Área</label>
														<div class="col-sm-8">
															<select class="form-control" data-bind="options: tipoareaa, optionsText: 'd_area', optionsValue: 'id_tipo_area', value: tipoarea, optionsCaption: 'Elegir ...'">
															</select>
														</div>
													</div>
													<div class="form-group"> 
								...
								<section id="section-2">
									<div class="graph-2 general">
										...
										<div>
											<table class="table table-stripped table-bordered" data-model="AreaViewModel">
												<thead>
													<tr>
														<th>Folio</th>
														<th>Nombre</th>
												...
												<tbody data-bind="foreach:area">
													<tr>
														<td data-bind="text:folio_area" ></td><!--//campos de tabla BD-->
														<td data-bind="text:nombre_area"></td>
														<td data-bind="text:d_area"></td>
