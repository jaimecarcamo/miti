...
<body >
			...
			<div class="inner-content">	
				<div class="outter-wp">
					...
					<div id="tabs" class="tabs">
						<h1 style="padding-left: 50px;font-weight: bold">BODEGA DE PRODUCTO</h1>
						<div class="graph">
							<nav>
								<ul>
							...
							<div class="content tab">
								<section id="section-1">
									<div class="graph-2 general">
										<h2 style="color:#052963; font-size: 1.8em; padding-bottom: 15px;">Formulario de Bodega de producto </h2>
										<div class="form-body">
											<form class="form-horizontal" data-model="BodegapViewModel" data-bind="submit:save">
												<div class="col-md-6 general">
													<h3 class="inner-tittle two">Ubicación</h3>
													<div class="form-group"> 
														<label for="inputEmail3" class="col-sm-4 control-label">Centro de Cultivo</label>
														<div class="col-sm-8">
															<select class="form-control" data-bind="options: centroa, optionsText: 'nombre_centro', optionsValue: 'id_c_cultivo', value: centro, optionsCaption: 'Elegir ...'">
															</select>
														</div>
													</div>
												</div>
												<div class="col-md-6 general">
													...
													<div class="form-group">
														<label for="inputEmail3" class="col-sm-4 control-label">Nombre de Bodega</label>
														<div class="col-sm-8">
															<input type="text" data-bind="value:nombre" class="form-control" id="focusedinput" placeholder="Default Input">
														</div> 
													</div>
													<div class="form-group"> 
														<label for="inputEmail3" class="col-sm-4 control-label">Código de Bodega</label> 
														<div class="col-sm-8"> 
								...
								<section id="section-2">
									<div class="graph-2 general">
										...
										<div>
											<table class="table table-stripped table-bordered" data-model="BodegapViewModel">
												<thead>
													<tr>
														<th>Folio</th>
														<th>Nombre</th>
												...
												<tbody data-bind="foreach:bodegas">
													<tr>
														<td data-bind="text:folio_b_producto" ></td><!--//campos de tabla BD-->
	...
	<script src="js/bodegap.js"></script> 
