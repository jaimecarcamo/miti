			...
			<div class="inner-content">
				...
				<div class="outter-wp">
					...
					<div id="tabs" class="tabs">
						<h1 style="padding-left: 50px; font-weight: bold">LÍNEA</h1>
						<div class="graph">
							<nav>
								<ul>
							...
							<div class="content tab">
								<section id="section-1">
									<div class="graph-2 general">
										<h2 style="color:#052963; font-size: 1.8em; padding-bottom: 15px;">Formulario de Línea</h2>
										<div class="form-body">
											<form class="form-horizontal" data-model="LineaViewModel" data-bind="submit:save"> 
												<div class="col-md-6 general">
													...
													<div class="form-group"> 
														...
														<div class="col-sm-8">
															<select class="form-control" data-bind="options: cuadrantea, optionsText: 'nombre_cuadrante', optionsValue: 'id_cuadrante', value: cuadrante, optionsCaption: 'Elegir ...',event:{change:getstock}">
															</select>
														</div>
													</div>
													<div class="form-group">
														<label for="inputEmail3" class="col-sm-4 control-label">Stock de Línea</label>
														<div class="col-sm-2">
												...
												<div class="col-md-6 general">
													...
													<div class="form-group">
														<label for="inputEmail3" class="col-sm-4 control-label">Nombre Línea</label>
														<div class="col-sm-8">
															<input type="text" data-bind="value:nombre" class="form-control" id="focusedinput" placeholder="Default Input">
														</div> 
													</div>
													<div class="form-group"> 
														<label for="inputEmail3" class="col-sm-4 control-label">Código Línea</label> 
														<div class="col-sm-8"> 
													...
													<div class="form-group"> 
														<label for="inputEmail3" class="col-sm-4 control-label">Cantidad Cuelga</label> 
														<div class="col-sm-8"> 
								...
								<section id="section-2">
									<div class="graph-2 general">
										...
										<div>
											<table class="table table-stripped table-bordered" data-model="LineaViewModel">
												<thead>
													<tr>
														<th>Folio</th>
														<th>Nombre</th>
														<th>Cantidad cuelga</th>
														<th>stock linea</th>
												...
												<tbody data-bind="foreach:linea">
													<tr>
														<td data-bind="text:folio_linea"></td><!--//campos de tabla BD-->
														<td data-bind="text:nombre_linea"></td>
														<td data-bind="text:cantidad_cuelga"></td>
														<td data-bind="text:unidad_linea"></td>
