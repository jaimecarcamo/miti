			...
			<div class="inner-content">
				...
				<div class="outter-wp">
					...
					<div id="tabs" class="tabs">
						<h1 style="padding-left: 50px; font-weight: bold">CENTRO DE CULTIVO </h1>
						<div class="graph">
							<nav>
								<ul>
							...
							<div class="content tab">
								<section id="section-1">
									<div class="graph-2 general">
										<h2 style="color:#052963; font-size: 1.8em; padding-bottom: 15px;">Formulario Centro de Cultivo </h2>
										<div class="form-body">
											<form class="form-horizontal" data-model="CentroViewModel" data-bind="submit:save"> 
												<div class="col-md-6 general">
													...
													<div class="form-group"> 
														<label for="inputEmail3" class="col-sm-4 control-label">Cantidad Cuadrante</label> 
														<div class="col-sm-8"> 
															<input type="text" data-bind="value:cantidad" class="form-control" id="focusedinput" placeholder="Default Input">
														</div>
													</div>	
													<div class="form-group"> 
														<label for="inputEmail3" class="col-sm-4 control-label">Área</label>
														<div class="col-sm-8"> 
															<select class="form-control" data-bind="options: areaa, optionsText: 'nombre_area', optionsValue: 'id_area', value: area, optionsCaption: 'Elegir ...'">
															</select>
														</div>
													</div>
													<div class="form-group"> 
												...
												<div class="col-md-6 general second">
													<h3 class="inner-tittle two">Legales</h3>
													<div class="form-group"> 
														<label for="inputEmail3" class="col-sm-4 control-label">Cod. Concesión</label>
														<div class="col-sm-8">
															<select class="form-control" data-bind="options: concesiona, optionsText: 'nombre_concesion', optionsValue: 'id_concesion', value: concesion, optionsCaption: 'Elegir ...'">
															</select>
														</div>
													</div>
													<div class="form-group"> 
														<label for="inputEmail3" class="col-sm-4 control-label">Cod. Decreto</label>
														<div class="col-sm-8"> 
															<select class="form-control" data-bind="options: decretoa, optionsText: 'nombre_decreto', optionsValue: 'id_decreto', value: decreto, optionsCaption: 'Elegir ...'">
															</select>
														</div>
													</div>
													<div class="form-group"> 
														<label for="inputEmail3" class="col-sm-4 control-label">Fecha Decreto</label>
														<div class="col-sm-8"> 
															<select class="form-control" data-bind="options: decretoa, optionsText: 'fecha_inicio', optionsValue: 'id_decreto', value: decreto, optionsCaption: 'Elegir ...'">
															</select>
														</div>
													</div>
													<div class="form-group"> 
														<label for="inputEmail3" class="col-sm-4 control-label">Tipo de Centro</label>
														<div class="col-sm-8"> 
															<select class="form-control" data-bind="options: t_centroa, optionsText: 'd_centro', optionsValue: 'id_tipo_centro', value: t_centro, optionsCaption: 'Elegir ...'">
															</select>
														</div>
													</div>
													<div class="form-group">	
														<label for="inputEmail3" class="col-sm-4 control-label">Descripción</label><div class="col-sm-8 form-group1 ">
								...
								<section id="section-2">
									<div class="graph-2 general">
										...
										<table class="table table-stripped table-bordered" data-model="CentroViewModel">
											<thead>
												<tr>
													<th>Folio</th>
													<th>Nombre</th>
													<th>Fecha Inicio</th>
													<th>cantidad cuadrante</th>
													<th>Descripcion</th>
													<th>Área</th>
													<th>Estado</th>
											...
											<tbody data-bind="foreach:centro">
												<tr>
													<td data-bind="text:folio_centro"></td><!--//campos de tabla BD-->
													<td data-bind="text:nombre_centro"></td>
													<td data-bind="text:fecha_inicio"></td>
													<td data-bind="text:cantidad_cuadrante"></td>
													<td data-bind="text:descripcion"></td><!--//campos de tabla BD-->
													<td data-bind="text:nombre_area"></td>
													<td data-bind="text:d_estado"></td>
													<td data-bind="text:d_centro"></td>
													<td data-bind="text:nombre_concesion"></td>
													<td data-bind="text:nombre_decreto"></td><!--//campos de tabla BD-->
													<td>
